...
@pytest.mark.parametrize("payload", [
    ...
    {"barcode": "036000291452", "quantity": 0, "price_per_unit": 5.0},
    {"barcode": "036000291452", "quantity": -1, "price_per_unit": 5.0},
    {"barcode": "036000291452", "quantity": 1, "price_per_unit": 0},
    {"barcode": "036000291452", "quantity": 1, "price_per_unit": -1},
])
...
async def test_issue_order_product_not_found(client, auth_tokens):
    payload = valid_order_payload("036000291452")
...
async def test_issue_order_no_auth(client):
    resp = await client.post(
        "/api/v1/orders",
        json={"barcode": "036000291452", "quantity": 1, "price_per_unit": 5.0},
        follow_redirects=True,
    )
...
@pytest.mark.parametrize("payload", [
    ...
    {"product_barcode": "036000291452", "quantity": 0, "price_per_unit": 5.0},
    {"product_barcode": "036000291452", "quantity": -1, "price_per_unit": 5.0},
])
...
async def test_payfor_order_no_auth(client):
    resp = await client.post(
        "/api/v1/orders/payfor",
        json={"product_barcode": "036000291452", "quantity": 1, "price_per_unit": 5.0},
        follow_redirects=True,
    )
    assert resp.status_code == 401
